...
export const getMeterData = createSelector(
  getMeterState,
  (state: MeterDataState) => state.meterData
);
export const addMeterData = createSelector(
  getMeterState,
  (state: MeterDataState) => state.addMeterData
);
export const deleteMeterData = createSelector(
  getMeterState,
  (state: MeterDataState) => state.deleteMeterData
);
0;
